...
app.post('/email', function (req, res, next) {
  ...
  var mailOptions = {
    ...
    html: '<ul>' + '<li>From: ' + req.body.email + '</li>' + '<li>Message: ' + req.body.message + '</li>' + '</ul>'
  }
  transporter.sendMail(mailOptions, function (error, info) {
    ...
    // If you felt like it, you could do fancy renders here, or a thank you page or something.
    res.redirect('/')
  })
})
